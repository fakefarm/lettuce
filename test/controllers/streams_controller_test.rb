...
class StreamsControllerTest < ActionController::TestCase
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post :create, stream: { amount: @stream.amount, auto_allocate: @stream.auto_allocate, equity_id: @stream.equity_id, estimate: @stream.estimate, name: @stream.name, user_id: @stream.user_id }
    end
  ...
  test "should update stream" do
    patch :update, id: @stream, stream: { amount: @stream.amount, auto_allocate: @stream.auto_allocate, equity_id: @stream.equity_id, estimate: @stream.estimate, name: @stream.name, user_id: @stream.user_id }
    assert_redirected_to stream_path(assigns(:stream))
  end
