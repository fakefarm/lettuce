...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { delete_account: @preference.delete_account, name: @preference.name, user_id: @preference.user_id }
    end
  ...
  test "should update preference" do
    patch :update, id: @preference, preference: { delete_account: @preference.delete_account, name: @preference.name, user_id: @preference.user_id }
    assert_redirected_to preference_path(assigns(:preference))
  end
