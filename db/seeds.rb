...
Expense.create(name: 'costco', budget: 420, balance: 29, book_id: 1, user_id: 1, family_id: 1, required: false, equity_id: 1, allocate: true)
Expense.create(name: 'rent', budget: 1250, balance: 0, book_id: 2, user_id: 1, family_id: 1, required: true, equity_id: 1, allocate: true)


Liability.create(starting_balance: 3400, current_balance: 3709, interest_rate: 8.3, nickname: 'goat farm', user_id: 1, family_id: 1, archive: false, flag: false)
